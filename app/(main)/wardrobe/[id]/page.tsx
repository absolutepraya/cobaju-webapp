...
import SelectSizeAndColor from "./components/select-size-and-color";
...
export default async function Page(props: {params: Promise<{id: string}>}) {
	...
	return (
		<div className="grid grid-cols-2 h-screen max-h-screen -mt-20 pt-20">
			<div className="bg-[#E6E5E3] relative h-full flex flex-col items-center justify-start p-2">
				<SelectButton />
				<div className="w-full flex h-10 m-4 px-4 mt-auto justify-between">
					...
					<div className="bg-white w-auto gap-5 px-4 text-sm shadow-md text-primary-dark tracking-widest flex items-center justify-between rounded-full">
						<IconShare3 />
						<ImageIcon />
						<CloudDownload />
						<CircleHelp />
				...
				<div className="px-4 overflow-y-scroll flex-1 w-full">
					<div className="">
						...
						<div className="flex w-full gap-4 mt-4">
							<Button className="bg-gray-400 rounded-full font-semibold text-lg w-36 h-12 text-white cursor-pointer hover:bg-gray-500">
